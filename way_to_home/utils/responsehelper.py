...
RESPONSE_400_EXISTED_EMAIL = HttpResponse('received email already exists', status=400)
...
RESPONSE_400_OBJECT_NOT_FOUND = HttpResponse('object not found', status=400)
