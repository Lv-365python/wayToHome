        ...
        return(
            <div className='wrapper'>
                <div className='StartBtnDiv'>
                    ...
                    {
                        isRouteFormOpen &&
                        <RouteSearchForm onClose={this.closeRouteForm} getCoordsWay={this.props.getCoordsWay.bind(this.props)} setEndPoint={this.props.setEndPoint} setStartPoint={this.props.setStartPoint}/>
                    }
                </div>
            </div>
        )
